...
const Projects = () => {
  const projects = [
    { img: DownlordHub, githubLink:"https://github.com/shivaverma1115/React_Downlord_hub",live:"https://downlordhub.vercel.app/", title: "DownlordHub (My 1st Solo Project)", desc: "A website (Solo Project) that allows user to downloads or watch Online Movies . It 's a DownloadHub web site cloning . User can online watch or downloads movies without Sign in & Sing up . This Website has React frame work so it has very smooth experience from users .A solo project build in Masai one week holiday .", },
